...
public class DeletarDadosTask extends AsyncTask<String, String, String> {
    ...
    public DeletarDadosTask(Context context){
    ...
    protected void onPreExecute(){
        super.onPreExecute();
        progressDialog.setMessage("Excluíndo dados..");
    ...
    protected String doInBackground(String... strings) {
        ...
        try{
            if (param[0].equals("cliente")){
                ...
                url = new URL(AppUtilWebService.URL_WEB_SERVICE+"deleteClientes.php?token=xpto");//TODO:Remover token fixado
                ...
                url = new URL(AppUtilWebService.URL_WEB_SERVICE+"deleteUsuario.phptoken=xpto");//TODO:Remover token fixado
        ...
        try{
            ...
            conn.setRequestMethod("DELETE");//"GET", "PUT", "POST", "DELETE"
        ...
        try{
            ...
            Log.e(AppUtil.TAG,"[DeletarDados] "+err.getMessage());
            return "ERRO ao deletar os dados";
        }finally {
            if(conn != null){
                conn.disconnect();
            }
